...
const GlobalUpdateRightsEntry = () => {
  ...
  return (
    <div className='module-content mt-2 global-update-content ' style={{ border: "3px double black", borderRadius: '5px', }}>
     <div className="container mt-2">
      {/* <Bounce duration={2000} className="fs-3"><center>Global Update Rights </center></Bounce> */}
