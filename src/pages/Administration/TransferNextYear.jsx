          ...
          <div className="home-page container">
            <p className=" p-lg-5 justify-content-end ms-5 me-5 fs-5" >
              <div className="Voucher-page container">
                <b className=" fw-bold"> Transfer Next Year </b>
                <p>
                  <b className="fw-bold align-items-lg-start text-uppercase"> Transfer Next Year </b> <br />
                  <ul>
...
export default TransferNextYear;
