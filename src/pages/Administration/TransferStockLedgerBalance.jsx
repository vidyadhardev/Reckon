...
const TransferStockLedgerBalance = () => {
  return (
    <>
          ...
          <div className="home-page container">
            <p className=" p-lg-5 justify-content-end ms-5 me-5 fs-5" >
              <div className="Voucher-page container">
                <Bounce duration={2000} className=" fw-bold"> Transfer Stock Ledger Balance </Bounce>
                <p>
                  <b className="fw-bold align-items-lg-start text-uppercase"> Transfer Stock Ledger Balance </b> <br />
                  <ul>
...
export default TransferStockLedgerBalance
