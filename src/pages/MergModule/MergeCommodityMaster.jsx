          ...
          <div className="home-page container">
            <p className=" p-lg-5 justify-content-end ms-5 me-5 fs-5" >
              <div className="Voucher-page container">
                <center> Merg commodity Master</center>
                <p>
                  <b className="fw-bold align-items-lg-start text-uppercase"> Merg commodity Master </b> <br />
                  <ul>
...
export default MergeCommodityMaster