          ...
          <div className="home-page container">
            <p className=" p-lg-5 justify-content-end ms-5 me-5 fs-5" >
              <div className="Voucher-page container">
                <center> Merge Item Module</center>
                <p>
                  <b className="fw-bold align-items-lg-start text-uppercase"> Merge Item Module </b> <br />
                  <ul>
...
export default MergeItemModule