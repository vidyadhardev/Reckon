      ...
      <div className="container mt-3" style={{ border: "3px double black", borderRadius: '5px', }}>
        <div className="home-page container">
          <p className=" p-lg-5 justify-content-end ms-5 me-5 fs-5" >
            ...
            <center> Merge Delivery Man </center>
              <p>
                <b className="fw-bold align-items-lg-start text-uppercase"> Merge Delivery Man </b> <br />
                <ul>
...
export default MergeDeliveryMan