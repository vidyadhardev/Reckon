...
// import './BillFormatExport.css'
const BillFormatExport = () => {
  return (
    <div className='module-content mt-2 voucher-content ' style={{ border: "3px double black", borderRadius: '5px', }}>
     <div className="container mt-2">
      <Bounce duration={2000} className="fw-bold fs-4 " ><center> Bill Formate Export</center></Bounce>
...
export default BillFormatExport;
