...
// import './BillFormatImport.css'
const BillFormatImport = () => {
 
  return (
    <div className='module-content mt-2 voucher-content ' style={{ border: "3px double black", borderRadius: '5px', }}>
      <div className="container mt-2">
        <Bounce duration={2000} className="fw-bold fs-4 " ><center>Bill Formate Import</center></Bounce>
        ...
        <div className="main-company-images  text-center ">
          <div className="image-contain mb-3 m-auto">
            <p>If you want to see English image then <b>click</b> on press button</p>
            <Button
...
export default BillFormatImport;
