     ...
     <div className="container mt-2">
        ...
        <div className="Voucher-page container">
          <p className=" p-lg-5 justify-content-end ms-5 me-5 fs-5" >
            ...
            <hr />
            <Bounce duration={2000}><b className="fw-bold align-items-lg-start text-uppercase">Import Calculation Option :- </b> </Bounce>
            <ol>
...
export default ImportCalculationEntry;
